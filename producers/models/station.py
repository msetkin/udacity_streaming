...
class Station(Producer):
    ...
    def __init__(
        ...
        topic_name = f"com.streaming.produce.station" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        logger.debug(f"object prodiced to topic: {self.station_id}, {train.train_id}, {direction}, {self.color.name}, {train.status.name}, {prev_station_id}, {prev_direction}")
